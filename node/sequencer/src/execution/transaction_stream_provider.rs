...
pub struct TransactionStreamProvider {
    next_l1_priority_id: u64,
    l1_mempool: DynL1Pool,
    l2_mempool: DynPool,
}

impl TransactionStreamProvider {
    pub fn new(
        next_l1_priority_id: u64,
        l1_mempool: DynL1Pool,
        l2_mempool: DynPool,
    ...
    pub fn request_transaction_stream(&mut self, block_command: BlockCommand) -> UnifiedTxStream {
        match block_command {
