...
mod v8_verifier {
    ...
    /// `end_params` of the `multiblock_batch.bin` shipped in zksync-airbender-prover
    /// (md5 `3e19df8c36564939950e0a079061ad1b`), from the airbender `end_params` tool
    /// (`tools/cli`) at tag v0.6.0-rc.1.
