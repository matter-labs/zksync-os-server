...
mod real_provers {
    ...
    use zksync_os_integration_tests::{
        NEXT_TO_L1, NEXT_TO_MULTIPROVER_L1, Tester, assert_zisk_lane_accepted, run_zisk_gpu_prover,
        spawn_airbender_prover, wait_for_zisk_aggregation_ranges, zisk_gpu_artifacts_available,
    };
    ...
    async fn two_lane_per_batch_e2e() -> anyhow::Result<()> {
        ...
        let env = NEXT_TO_MULTIPROVER_L1.environment().await?;
