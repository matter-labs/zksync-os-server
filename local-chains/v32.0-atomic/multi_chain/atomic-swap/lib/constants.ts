...
// Atomic layout (era-contracts `atomic-imt-interop`) — the single address table;
// lib/atomic.ts derives DEFAULT_ATOMIC_LAYOUT from these.
...
export const L2_INTEROP_COMMITMENT_TREE_ADDRESS = '0x0000000000000000000000000000000000010012';
export const L2_ATOMIC_FLOW_MANAGER_ADDRESS = '0x0000000000000000000000000000000000010014';
