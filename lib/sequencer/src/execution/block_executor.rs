    ...
    async fn run(
        ...
        loop {
            self.health_reporter
                .enter_state(SequencerState::WaitingForCommand);
            ...
            self.health_reporter
                .enter_state(SequencerState::InitializingVm);
            ...
            self.health_reporter
                .record_picked(block_number, Some(prepared_command.block_context.timestamp));
            tracing::info!(
                block_number,
            ...
            self.health_reporter.enter_state(SequencerState::Execution);
            ...
            self.health_reporter
                .enter_state(SequencerState::UpdatingMempool);
...
async fn check_block_production_limit(
    ...
    if already_produced_blocks_count >= limit {
        ...
        health_reporter.enter_state(SequencerState::WaitingForCommand);
