...
use crate::transaction::INTEROP_TX_TYPE_ID;
...
impl Transaction for InteropTx {
...
impl Typed2718 for InteropTx {
    fn ty(&self) -> u8 {
        INTEROP_TX_TYPE_ID
    }
}

impl Encodable2718 for InteropTx {
    ...
    fn encode_2718(&self, out: &mut dyn BufMut) {
        ...
        out.put_u8(INTEROP_TX_TYPE_ID);
        out.put_slice(&rlp_body);
    }
}

impl RlpEcdsaEncodableTx for InteropTx {
...
impl RlpEcdsaDecodableTx for InteropTx {
