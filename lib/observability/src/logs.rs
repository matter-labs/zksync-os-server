...
impl Logs {
    ...
    pub(super) fn build_filter(&self) -> EnvFilter {
        let mut directives = if self.disable_default_logs {
            ...
            "INFO,zksync_os_server=DEBUG,zksync_os_server::prover_api=DEBUG,zksync_os_sequencer=DEBUG,zksync_os_priority_tree=DEBUG,zksync_os_merkle_tree=DEBUG,".to_string()
        };
